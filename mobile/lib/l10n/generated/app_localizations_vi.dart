...
class AppLocalizationsVi extends AppLocalizations {
  ...
  @override
  String get searchNoResults => 'Không tìm thấy kết quả phù hợp. Hãy thử từ khóa khác.';
  @override
  String get searchError => 'Không kết nối được máy chủ. Kiểm tra mạng hoặc dùng thử demo.';
  @override
  ...
  @override
  String detailUpdatedAt(String date) => 'Cập nhật $date';
  @override
  ...
  @override
  String get settingsAiAssistantDesc => 'Gói miễn phí hoặc API key riêng, độ chi tiết, nguồn';
  @override
  String get settingsDataPrivacy => 'Dữ liệu & Quyền riêng tư';
  @override
  String get settingsDataPrivacyDesc => 'Cache, lịch sử, quyền vị trí, chuyển động, cỡ chữ';
  ...
  @override
  String get llmEnabledDesc => 'Khi tắt, bạn sẽ thấy kết quả tìm kiếm thô thay vì tóm tắt AI';
  @override
  ...
  @override
  String freeTierUsage(int used, int limit) => 'Đã dùng $used/$limit lượt hôm nay';
  @override
  ...
  @override
  String get clearCacheConfirm => 'Thao tác này sẽ xóa toàn bộ dữ liệu địa điểm đã lưu. Tiếp tục?';
  @override
  String get locationHistory => 'Lịch sử địa điểm';
  @override
  String get clearHistory => 'Xóa lịch sử';
  @override
  String get clearHistoryConfirm => 'Thao tác này sẽ xóa lịch sử tìm kiếm của bạn. Tiếp tục?';
  @override
  ...
  @override
  String get reducedMotionDesc => 'Tắt hiệu ứng chuyển động nền trong node-graph';
  @override
