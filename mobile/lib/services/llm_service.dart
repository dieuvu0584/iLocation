...
class LlmService {
  ...
  static const Map<String, String> searchQueryTemplates = {
    ...
    'safety_level': '{name} current travel safety advisory natural disasters political stability conflict war risk common scams crime',
    'safety_history': '{name} historical crime rate safety trends past major incidents',
