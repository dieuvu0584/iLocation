...
/// gì khác"). Covers every provider the app calls directly that still needs
/// a key — LLM, Weather, Search — since there's no backend to hold any of
/// them (CLAUDE.md "Quyết định đã chốt 2026-08-04 (đợt 2)"). Places/
/// Geocoding runs on OpenStreetMap and needs no key at all (đợt 3).
